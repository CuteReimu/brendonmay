translate_dict = {
    ...
    "Ignore Defense": "无视防御率",
    "Damage": "伤害",
    "Boss Damage": "Boss伤",
    "Damage To Normal Mobs": "对普通怪物伤害",
    "Status Resistance": "异常状态抗性",
    "Knockback Resistance": "稳如泰山",
    "ATT Power/Magic ATT": "攻击力/魔法力",
    "Bonus Exp": "额外经验值",
    "Arcane Force": "神秘力量",
    "1 Attack = ": "1攻击力=",
    "1 Main Stat =": "1主属性=",
    ...
    "Class:": "职业：",
    "Main Weapon:": "主武器：",
    "Upper Range Value": "面板上限",
    "Boss Damage %": "Boss伤%",
    "IED %": "无视防御率%",
    "Damage Bonus %": "额外伤害%",
    "Final Damage %": "最终伤害%",
    "Critical Damage %": "暴击伤害%",
    "Familiar Badge Effects": "怪怪卡组效果",
    "Familiar Lines": "怪怪卡词条",
    "Magnificent Soul Effect": "伟大灵魂效果",
    "Current Hyper Stats": "当前超级属性",
    "Optimized Hyper Stats": "优化后超级属性",
    "Total Points:": "总点数：",
    "Current Points:": "当前点数：",
    "Stat": "属性",
    "Stat Amount": "属性数值",
    "Locked": "锁定",
    "Legion Level": "联盟等级",
    "Current Grid Bonuses": "当前联盟格子占领加成",
    "Legion Attackers": "联盟攻击队员",
